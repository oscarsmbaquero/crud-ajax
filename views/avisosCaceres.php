...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Abiertas Cáceres</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="modal-body">
                ...
                <form class="needs-validation" novalidate>
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <!-- <div class="col-12  col-lg-6">
                            <div class="form-group mb-2">
                                <label class="" for="iptEstado"><i class="fas fa-dollar-sign fs-6"></i> <span
                                        class="small">Estado
                                    </span><span class="text-danger">*</span></label>
                                <input type="text" min="0" class="form-control form-control-sm" id="iptEstado"
                                    placeholder="Estado" required>
                                <div class="invalid-feedback">Debe ingresar el estado real</div>
                            </div>
                        </div>    
                        <div class="col-12  col-lg-12">    
                            <div class="form-group mb-12">
                                <label class="" for="iptObservacion"><i class="fas fa-dollar-sign fs-6"></i> <span
                                        class="small">Observación Astron
                                    </span><span class="text-danger">*</span></label>
                                <input type="text" min="0" class="form-control form-control-sm" id="iptObservacion"
                                    placeholder="Observaciones" required>
                                <div class="invalid-feedback">Debe ingresar una nota</div>
                            </div>
                        </div>     -->
...
$(document).ready(function() {
    ...
    table = $("#tabla_averias").DataTable({
        ...
        rowCallback:function(row,data)
       {
        ...
        ajax: {
            ...
            type: "POST",
            data: {
                'accion': 6 //1: LISTAR AVISOS CACERES
            },
        },
        responsive: {
            details: {
    ...
    /* ======================================================================================
    EVENTO AL DAR CLICK EN EL BOTON EDITAR AVISO
    =========================================================================================*/
    ...
    /* ======================================================================================
    EVENTO AL DAR CLICK EN EL BOTON ELIOMINAR AVISO
    =========================================================================================*/
    $('#tabla_averias tbody').on('click', '.btnEliminarAviso', function() {
        ...
        Swal.fire({
            title: 'Está seguro que esta tratado el aviso?',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            confirmButtonText: 'Si, esta tratado!',
...
/*===================================================================*/
//EVENTO QUE GUARDA LOS DATOS DEL PRODUCTO, PREVIA VALIDACION DEL INGRESO 
