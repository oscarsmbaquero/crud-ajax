...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Tratados Cáceres</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
$(document).ready(function() {
    ...
    table = $("#tabla_averias").DataTable({
        ...
        rowCallback:function(row,data)
       {
        ...
        ajax: {
            ...
            type: "POST",
            data: {
                'accion': 8 //1: LISTAR AVISOS CACERES tratados
            },
        },
        responsive: {
            details: {
    ...
    $('#tabla_averias tbody').on('click', '.btnEliminarAviso', function() {
        ...
        accion = 12; //seteamos la accion para editar
        ...
        Swal.fire({
            title: 'Está seguro de cerrar el aviso?',
            icon: 'warning',
                ...
                $.ajax({
                    ...
                    success: function(respuesta) {
                        ...
                        if (respuesta == "ok") {
                            ...
                            Toast.fire({
                                icon: 'success',
                                title: 'El Aviso se cerró correctamente'
                            });
                            ...
                            Toast.fire({
                                icon: 'error',
                                title: 'El aviso no se pudo cerrar'
                            });
                        }
