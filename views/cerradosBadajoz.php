...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Cerrados Badajoz</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
$(document).ready(function() {
    ...
    table = $("#tabla_averias").DataTable({
        ...
        rowCallback:function(row,data)
       {
                ...
                if(data[6] == "Prioritario")
                {
                    $($(row).find("td")[1]).css("background-color","red");
        ...
        ajax: {
            ...
            type: "POST",
            data: {
                'accion': 11 //1: LISTAR AVISOS CERRADOS BADAJOZ
            },
        },
        responsive: {
            details: {
                ...
                }, 
                {
                    ...
                    render: function(data, type, full, meta)
                    {
                      return "<center>" +
                                ...
                                // "</span>" +
                                "<span class='btnEliminarAviso text-danger px-1' style='cursor:pointer;'>" + 
    ...
    /* ======================================================================================
    EVENTO AL DAR CLICK EN EL BOTON EDITAR AVISOS
    =========================================================================================*/
    ...
    /* ======================================================================================
    EVENTO AL DAR CLICK EN EL BOTON ELIOMINAR AVISOS
    =========================================================================================*/
    $('#tabla_averias tbody').on('click', '.btnEliminarAviso', function() {

        accion = 13; //seteamos la accion para editar
        ...
        Swal.fire({
            title: 'Está seguro de eliminar el aviso ? <br> La incidencia se borrará definitivamente',
            icon: 'warning',
...
//     var iptAveria = $("#iptAveria").val();
//     var iptPrecioVentaReg = $("#iptPrecioVentaReg").val();
//     var Utilidad = iptPrecioVentaReg - iptAveria;
...
/*===================================================================
 *EVENTO QUE LIMPIA LOS MENSAJES DE ALERTA DE INGRESO DE DATOS DE CADA 
 *INPUT AL CANCELAR LA VENTANA MODAL
/*===================================================================*/
